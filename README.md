...
I build intelligent systems, scalable backend architectures, and open-source tools that push the boundaries of AI. From training datasets to production-ready applications, I turn ideas into clean, efficient code.
...
- **Dev Tools & Practices:** Docker, Git, Linux, REST APIs, CI/CD  
...
|---------|------------|-------------|
| [Facemash AI Backend](https://github.com/yourusername/facemash-ai) | Python, SQL, AI | Scalable AI-powered social network backend |
